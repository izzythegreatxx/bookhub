...
def get_books():
    try:
        ...
        current_app.logger.exception("Failed to fetch books")
...
def get_book(book_id):
    try:
        ...
        current_app.logger.exception("Failed to fetch book")
        return jsonify({"message": "Internal server error"}), 500
...
def create_book():
    try:
        ...
        current_app.logger.exception("Failed to create book")
        return jsonify({"message": "Internal server error"}), 500
...
def update_book(book_id):
    try:
        ...
        current_app.logger.exception("Failed to update book")
        return jsonify({"message": "Internal server error"}), 500
...
def delete_book(book_id):
    try:
        ...
        current_app.logger.exception("Failed to delete book")
        return jsonify({"message": "Internal server error"}), 500
...
def search_books():
    try:
        ...
        current_app.logger.exception("Failed to search books")
        return jsonify({"message": "Internal server error"}), 500   
